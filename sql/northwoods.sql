...
-- filepath: /c:/Users/Owner/DatabaseSQL_Lab03/northwoods.sql
-- script to create NORTHWOODS database
...
BEGIN
   EXECUTE IMMEDIATE 'DROP TABLE course_section CASCADE CONSTRAINTS';
EXCEPTION
   WHEN OTHERS THEN
      IF SQLCODE != -942 THEN
         RAISE;
...
INSERT INTO term (term_id, term_desc, status) VALUES
(2, 'Spring 2016', 'CLOSED');

INSERT INTO term (term_id, term_desc, status) VALUES
(3, 'Summer 2016', 'CLOSED');

INSERT INTO term (term_id, term_desc, status) VALUES
(4, 'Fall 2020', 'CLOSED');

INSERT INTO term (term_id, term_desc, status) VALUES
(5, 'Spring 2017', 'CLOSED');
...
(1, 'MIS 101', 4, 1, 2, 'MWF', TO_DATE('10:00 AM', 'HH:MI AM'), TO_DSINTERVAL('0 00:00:50.00'), 1, 140, 20);

INSERT INTO course_section VALUES
(2, 'MIS 101', 4, 2, 3, 'TR', TO_DATE('09:30 AM', 'HH:MI AM'), TO_DSINTERVAL('0 00:01:15.00'), 7, 35, 15);

INSERT INTO course_section VALUES
(3, 'MIS 101', 4, 3, 3, 'MWF', TO_DATE('08:00 AM', 'HH:MI AM'), TO_DSINTERVAL('0 00:00:50.00'), 2, 35,12);

INSERT INTO course_section VALUES
(4, 'MIS 301', 4, 1, 4, 'TR', TO_DATE('11:00 AM', 'HH:MI AM'), TO_DSINTERVAL('0 00:01:15.00'), 6, 35, 10);

INSERT INTO course_section VALUES
(5, 'MIS 301', 5, 2, 4, 'TR', TO_DATE('02:00 PM', 'HH:MI PM'), TO_DSINTERVAL('0 00:01:15.00'), 6, 35, 8);

INSERT INTO course_section VALUES
(6, 'MIS 441', 5, 1, 1, 'MWF', TO_DATE('09:00 AM', 'HH:MI AM'), TO_DSINTERVAL('0 00:00:50.00'), 5, 30, 6);

INSERT INTO course_section VALUES
(7, 'MIS 441', 5, 2, 1, 'MWF', TO_DATE('10:00 AM', 'HH:MI AM'), TO_DSINTERVAL('0 00:00:50.00'), 5, 30, 12);

INSERT INTO course_section VALUES
(8, 'CS 155', 5, 1, 5, 'TR', TO_DATE('08:00 AM', 'HH:MI AM'), TO_DSINTERVAL('0 00:01:15.00'), 3, 35, 20);

INSERT INTO course_section VALUES
(9, 'MIS 451', 5, 1, 2, 'MWF', TO_DATE('02:00 PM', 'HH:MI PM'), TO_DSINTERVAL('0 00:00:50.00'), 5, 35, 12);

INSERT INTO course_section VALUES
(10, 'MIS 451', 5, 2, 2, 'MWF', TO_DATE('03:00 PM', 'HH:MI PM'), TO_DSINTERVAL('0 00:00:50.00'), 5, 35, 8);

INSERT INTO course_section VALUES
(11, 'MIS 101', 6, 1, 1, 'MTWRF', TO_DATE('08:00 AM', 'HH:MI AM'), TO_DSINTERVAL('0 00:01:30.00'), 1, 50, 20);

INSERT INTO course_section VALUES
(12, 'MIS 301', 6, 1, 2, 'MTWRF', TO_DATE('08:00 AM', 'HH:MI AM'), TO_DSINTERVAL('0 00:01:30.00'), 6, 35, 18);

INSERT INTO course_section VALUES
(13, 'MIS 441', 6, 1, 3, 'MTWRF', TO_DATE('09:00 AM', 'HH:MI AM'), TO_DSINTERVAL('0 00:01:30.00'), 5, 35, 14);
